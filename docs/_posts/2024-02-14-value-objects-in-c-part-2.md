...
<h2 class="wp-block-heading">2. Choosing the property modifiers</h2>
...
<pre class="wp-block-code alignwide"><code><code>public class Person<br>{<br>    public string Name { get; set; }<br>}<br><br>// Initialization and mutation<br>var person = new Person { Name = "Alice" };<br>person.Name = "Bob"; // Property can be changed after initialization</code></code></pre>

<p>However, records also support this but is generally considered an <strong>anti-pattern</strong>.</p>

<pre class="wp-block-code alignwide"><code>public <strong>record </strong>Person
<br>{
...
<h3 class="wp-block-heading">Immutable Properties with <code>init</code></h3>
...
<pre class="wp-block-code alignwide"><code><code>public &#91;class|record] Person<br>{<br>    public string Name { get; <strong>init;</strong> }<br>}<br><br>// Initialization<br>var immutablePerson = new Person { Name = "Alice" };<br>// immutablePerson.Name = "Bob"; // This line would result in a compile-time error<br></code></code></pre>

<h3 class="wp-block-heading">Read-Only Properties with <code>get</code></h3>
...
<pre class="wp-block-code alignwide"><code><code>public &#91;class|record] Person<br>{<br>    public string Name { get; }<br><br>    public Person(string name)<br>    {<br>        Name = name;<br>    }<br>}<br><br>// Initialization<br>var readOnlyPerson = new PersonWithReadOnlyProperty("Alice");<br>// readOnlyPerson.Name = "Bob"; // Not allowed<br></code></code></pre>

<h3 class="wp-block-heading">Required Properties with <code>required</code></h3>
